...
// Cadence / Anchoring: pull every layer's A/B mix toward isomorphy
...
// Rupture: a controlled-chaos burst : Context bloom/trails/haze
...
// Monomedia drop: drop one medium as a transition tension marker.
...
// ── Relation-score export ("future work": a representational
