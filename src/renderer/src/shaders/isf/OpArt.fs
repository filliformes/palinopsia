/*{
  "DESCRIPTION": "Op-Art : hard-edged optical-illusion fields. Black-and-white waves, grids, moiré and herringbone with illusory motion; a matte geometric generator that sits at home under the Finalizer's anaglyph 3D. Curated and minimal, never a radial kaleidoscope or plasma.",
  "CREDIT": "Palinopsia",
  "ISFVSN": "2",
...
void main() {
  ...
  if (mode == 0) {
    ...
    // A square grid deformed by a slowly drifting off-centre bulge.
