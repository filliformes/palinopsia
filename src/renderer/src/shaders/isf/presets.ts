...
export const PRESETS_BY_ID: Record<string, ShaderPreset[]> = {
  ...
  'fx-context': [
    { name: 'Clean', values: { trails: 0, blur: 0, bloom: 0.1, depth: 0.12, haze: 0, atmosphere: [0.5, 0.58, 0.72, 1], lightGlow: 0, lightColor: [1, 0.92, 0.8, 1], light: [0.5, 0.55] } },
    { name: 'Gentle depth', values: { trails: 0.2, blur: 0.08, bloom: 0.3, depth: 0.35, haze: 0.15, atmosphere: [0.5, 0.58, 0.72, 1], lightGlow: 0.25, lightColor: [1, 0.92, 0.8, 1], light: [0.5, 0.55] } },
    { name: 'Deep space', values: { trails: 0.3, blur: 0.12, bloom: 0.4, depth: 0.7, haze: 0.5, atmosphere: [0.12, 0.16, 0.3, 1], lightGlow: 0.2, lightColor: [0.7, 0.8, 1, 1], light: [0.5, 0.5] } },
    { name: 'Dreamy bloom', values: { trails: 0.4, blur: 0.3, bloom: 0.75, depth: 0.3, haze: 0.2, atmosphere: [0.75, 0.68, 0.85, 1], lightGlow: 0.5, lightColor: [1, 0.85, 0.95, 1], light: [0.5, 0.5] } },
    { name: 'Long trails', values: { trails: 0.62, blur: 0.18, bloom: 0.35, depth: 0.4, haze: 0.1, atmosphere: [0.5, 0.58, 0.72, 1], lightGlow: 0.2, lightColor: [1, 0.92, 0.8, 1], light: [0.5, 0.55] } },
    { name: 'Soft focus', values: { trails: 0.15, blur: 0.5, bloom: 0.4, depth: 0.3, haze: 0.15, atmosphere: [0.6, 0.6, 0.7, 1], lightGlow: 0.25, lightColor: [1, 0.95, 0.88, 1], light: [0.5, 0.55] } },
    { name: 'Candlelight', values: { trails: 0.3, blur: 0.15, bloom: 0.55, depth: 0.45, haze: 0.25, atmosphere: [0.3, 0.28, 0.35, 1], lightGlow: 0.6, lightColor: [1, 0.78, 0.45, 1], light: [0.5, 0.42] } },
    { name: 'Underwater', values: { trails: 0.35, blur: 0.28, bloom: 0.3, depth: 0.5, haze: 0.6, atmosphere: [0.18, 0.5, 0.6, 1], lightGlow: 0.3, lightColor: [0.7, 0.95, 1, 1], light: [0.5, 0.3] } },
    { name: 'Void', values: { trails: 0.25, blur: 0.1, bloom: 0.2, depth: 0.72, haze: 0.35, atmosphere: [0.08, 0.1, 0.18, 1], lightGlow: 0.15, lightColor: [0.6, 0.7, 1, 1], light: [0.5, 0.5] } },
    { name: 'Aurora', values: { trails: 0.5, blur: 0.2, bloom: 0.62, depth: 0.4, haze: 0.3, atmosphere: [0.25, 0.75, 0.6, 1], lightGlow: 0.45, lightColor: [0.6, 1, 0.85, 1], light: [0.4, 0.35] } }
  ],
  // ── Generators ──────────────────────────────────────────────────────
  'drift-field': [
