...
export const MODULATOR_BLURBS: Record<string, string> = {
  ...
  'euclid': 'Spreads a handful of pulses as evenly as possible around a loop of steps, the way world rhythms are built, and fires a gate on each. A few pulses in many steps gives sparse, lop-sided patterns. Ideal for driving something on and off in time.',
